...
{
    public class AKey : Actor
    {
        public AKey(Vector2 pos, Stage myStage) : base(pos, myStage)
        {
        ...
        public override void Load()
        {
            ...
            spriteRenderer.tex = EngineHelpers.GetTexture("AKey");
        ...
        {
            if (EngineGame.instance.keyboardState.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.A))
            {
                keyPressed = true;
            }
