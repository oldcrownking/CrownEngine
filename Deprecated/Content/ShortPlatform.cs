...
{
    public class ShortPlatform : Actor
    {
        public ShortPlatform(Vector2 pos, Stage myStage) : base(pos, myStage)
        {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(EngineHelpers.GetTexture("ShortPlatform"), position - myStage.screenPosition + crumbleOffset, new Rectangle(0, (deathTicks > 60 ? 6 : 0), 16, 6), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
